...
class PlanningGraph():
    ...
    def add_action_level(self, level):
        ...
        for action in self.all_actions:
            ...
            if aNode.prenodes.issubset(self.s_levels[level]):
                ...
                curALevelSet.add(aNode)
        self.a_levels.append(curALevelSet)
    ...
    def add_literal_level(self, level):
        ...
        for aNode in self.a_levels[level-1]:
            for sNode in aNode.effnodes:
                ...
                curSLevelSet.add(sNode)
        self.s_levels.append(curSLevelSet)
    ...
    def inconsistent_effects_mutex(self, node_a1: PgNode_a, node_a2: PgNode_a) -> bool:
        ...
        :return: bool
        """
        # n1's add actions are inconsistant with n2's remove
        n1PosNotN2NegBool = bool(set(node_a1.action.effect_add) & set(node_a2.action.effect_rem))

        # n2's add actions are inconsistant with n1's remove
        n2PosNotN1NegBool = bool(set(node_a2.action.effect_add) & set(node_a1.action.effect_rem))

        return n1PosNotN2NegBool or n2PosNotN1NegBool
    ...
    def interference_mutex(self, node_a1: PgNode_a, node_a2: PgNode_a) -> bool:
        ...
        # n1's pos precond not interfered by n2's neg eff
        n1PosPrecondNotN2NegEffBool = bool(set(node_a1.action.precond_pos) & set(node_a2.action.effect_rem))
        
        # n2's pos precond not interfered by n1's neg eff
        n2PosPrecondNotN1NegEffBool = bool(set(node_a2.action.precond_pos) & set(node_a1.action.effect_rem))
        
        # n1's neg precond not interfered by n2's pos eff
        n1NegPrecondNotN2PosEffBool = bool(set(node_a1.action.precond_neg) & set(node_a2.action.effect_add))
        
        # n2's neg precond not interfered by n1's pos eff
        n2NegPrecondNotN1PosEffBool = bool(set(node_a2.action.precond_neg) & set(node_a1.action.effect_add)) 

        return n1PosPrecondNotN2NegEffBool or n2PosPrecondNotN1NegEffBool or n1NegPrecondNotN2PosEffBool or n2NegPrecondNotN1PosEffBool
    ...
    def competing_needs_mutex(self, node_a1: PgNode_a, node_a2: PgNode_a) -> bool:
        ...
        # n1's pos precond compete with n2's neg cond
        for n1Parent in node_a1.parents:
            for n2Parent in node_a2.parents:
                if n1Parent.is_mutex(n2Parent):
                    return True
        return False
    ...
    def inconsistent_support_mutex(self, node_s1: PgNode_s, node_s2: PgNode_s):
        ...
        for n1Parent in node_s1.parents:
            for n2Parent in node_s2.parents:
                if not n1Parent.is_mutex(n2Parent):
                    return False
        # return False
        return True
