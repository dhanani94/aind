    ...
    def get_move(self, game, legal_moves, time_left):
        ...
        **********************************************************************
        ...
        if len(legal_moves) == (game.width*game.height): 
            return (4, 4) ## what if the board is bigger?
            ...
            if self.iterative:
                ...
                while(True):
                    if self.method == "minimax":
                        _, curBestMove = self.minimax(game, curDepth)
                    if self.method == "alphabeta":
                        _, curBestMove = self.alphabeta(game, curDepth)
                    curDepth += 1
            else:
                if self.method == "minimax": 
                    _, curBestMove = self.minimax(game, self.search_depth) 
                if self.method == "alphabeta":
